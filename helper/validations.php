...
}, 'شماره شبای وارد شده معتبر نمی‌باشد.');
 ...
 * @return bool
 */
Validator::extend('credit_card', function ($attribute, $card_number, $parameters, $validator) {
 ...
 * @return bool
 */
Validator::extend('zip_code', function ($attribute, $code, $parameters, $validator) {
...
Validator::extend('shenase_meli', function ($attribute, $value, $parameters, $validator) {
    ...
    if ($remaining == $controlNumber)
        ...
        return false;
}, 'شناسه ملی وارد شده معتبر نمی‌باشد.');
